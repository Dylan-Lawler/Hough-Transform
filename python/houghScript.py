...
for file in os.listdir(datadir):
    if file.endswith('.jpg'):
        ...
        # Added to get blurred gaussian for write up 
        ...
        smooth_img = myImageFilter(img, gaussian_kernel)
        
        
        # everything below here just saves the outputs to files
        fname = '%s/%s_00Gaussian.png' % (resultsdir, file)
        cv2.imwrite(fname, 255 * smooth_img / smooth_img.max())
